let handler = async(m, { conn }) => {
  ...
  const sentMsg = await conn.sendContactArray(m.chat, [
    ...
    [`${owner[2]}`, `${await conn.getName(owner[2]+'@s.whatsapp.net')}`, `👑 Developer Bot `, `🚫 Don't call me 😡`, `raselcomel18@gmail.com`, `🇮🇩 Indonesia`, `🚀 https://github.com/aniq12`, `👤 Gada pawang nih senggol dong 😣`],
