...
<a href="https://github.com/Fokusdotid/bersama/graphs/contributors"><img title="Contributors" src="https://img.shields.io/github/contributors/Fokusdotid/bersama?label=Contributors&color=blue&style=flat-square"></a>
<a href="https://github.com/Fokusdotid/bersama/issues"><img title="Issues" src="https://img.shields.io/github/issues/Fokusdotid/bersama?label=Issues&color=success&style=flat-square"></a>
...
[![Deploy](https://www.herokucdn.com/deploy/button.svg)](https://heroku.com/deploy?template=https://github.com/FokusDotId/bersama)
## Join Group Diskusi
[![BOT DISCUSSION GROUP](https://img.shields.io/badge/WhatsApp%20Group-25D366?style=for-the-badge&logo=whatsapp&logoColor=white)](https://chat.whatsapp.com/Fm6gRtvuCDN9abXVIfekAK) 
**NO BOT**
...
```bash
git clone https://github.com/fokusdotid/Bersama.git
cd Bersama
npm i
node .
```
...
contoh nama file `bersama.json` maka penggunaannya `node . --session 'bersama'`
